...
export default function GalleryMasonry({
  ...
  subheadline = "A glimpse of signature dishes, handcrafted cocktails, and the warm ambiance that defines every evening with us.",
  images = [
    {
      url: "https://res.cloudinary.com/dwc294mzm/image/upload/c_fill,w_1200,h_800,g_auto/v1771577099/site-images/restaurant/10445929.jpg",
      alt: "Signature plated dish",
      caption: "Seasonal chef tasting course",
    },
    {
      url: "https://res.cloudinary.com/dwc294mzm/image/upload/c_fill,w_1200,h_800,g_auto/v1771577071/site-images/restaurant/10135116.jpg",
      alt: "Elegant dining table",
      caption: "Intimate candlelit dining",
    },
    {
      ...
      caption: "Fresh ingredients, refined technique",
    },
    {
      ...
      alt: "Craft cocktail at bar",
      caption: "House-crafted cocktail pairings",
    },
    {
      ...
      alt: "Dessert plate",
      caption: "Pastry artistry for a sweet finish",
    },
    {
      url: "https://res.cloudinary.com/dwc294mzm/image/upload/c_fill,w_1200,h_800,g_auto/v1771577056/site-images/restaurant/110813.jpg",
      alt: "Restaurant interior",
      caption: "Warm, sophisticated ambiance",
    },
  ],
