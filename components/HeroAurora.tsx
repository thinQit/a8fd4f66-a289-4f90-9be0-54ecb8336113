...
export default function HeroAurora({
  ...
  headline = "Where Fire, Flavor, and Elegance Meet",
  subheadline = "Experience a warm, modern dining destination featuring chef-driven seasonal cuisine, curated wines, and unforgettable hospitality.",
