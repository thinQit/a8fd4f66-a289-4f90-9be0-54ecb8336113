...
export default function CTAVortex({
  headline = "Reserve Your Table for an Unforgettable Evening",
  description = "Join us for seasonal tasting menus, handcrafted cocktails, and warm hospitality in an intimate setting.",
  ctaLabel = "Book Now",
  ctaHref = "#reservation",
  secondaryCtaLabel = "Call Us",
  secondaryCtaHref = "tel:+15550132647",
